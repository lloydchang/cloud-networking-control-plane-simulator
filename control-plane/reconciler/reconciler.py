        ...
        if action.action_type == ActionType.CREATE:
            ...
            for switch in self.switches:
                try:
                    ...
                    # ⚡ OPTIMIZATION:
                    # Avoid N+1 query problem by re-using the desired_state fetched
                    # at the beginning of the reconciliation cycle instead of calling
                    # _fetch_desired_state() inside this loop.
                    #
                    # Performance Impact:
                    # - Reduces DB queries from (1 + num_switches) to 1 per cycle.
                    # - For 3 switches, this is a 75% reduction in DB load.
