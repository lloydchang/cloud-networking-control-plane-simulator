        ...
        if action.action_type == ActionType.CREATE:
            ...
            for switch in self.switches:
                try:
                    ...
                    # This is an O(n^2) operation, but acceptable for a simulator
                    # with a small number of VPCs.
                    #
                    # PERFORMANCE: The `desired_state` is passed in to avoid a
                    # redundant database query in this loop (N+1 problem).
