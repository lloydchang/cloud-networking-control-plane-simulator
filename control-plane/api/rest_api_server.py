...
async def vpc_view():
    """Serve the static VPC view HTML page"""
    # Try to serve the pre-built static index.html first
    index_html_path = os.path.join(os.path.dirname(__file__), "..", "..", "docs", "index.html")
    ...
    if os.path.exists(index_html_path):
        try:
            ...
            logging.warning(f"Error reading static index.html: {e}")
    
    # Fallback to the basic vpc.html template
