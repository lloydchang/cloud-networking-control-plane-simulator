/**
 * Scenario: Private Mesh VPN (Headscale)
 * Standard flex layout.
 */
function renderScenarioMesh(scenario, scenarioResources, vpcs, hubs, data, formatVpcHtml, formatHubHtml, formatConnectionsHtml, displayCounter, vpcCount, hubCount, dcCount) {
